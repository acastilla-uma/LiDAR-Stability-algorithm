"""
Script para generar datos de prueba sintÃ©ticos GPS + Estabilidad para visualizaciÃ³n.
...
def generate_synthetic_data(n_points=500, vehicle_speed=15):
    """
    Genera datos sintÃ©ticos GPS + Estabilidad.
    
    Args:
        n_points: NÃºmero de puntos en la trayectoria
        vehicle_speed: Velocidad del vehÃ­culo en m/s
    ...
    # ParÃ¡metros
    PHI_C = 33.79  # Ã¡ngulo crÃ­tico de vuelco (grados)
    g = 9.81
    ...
    # ETRS89 UTM30N: 1 grado â‰ˆ 111 km
    ...
    dt_sec = 1 / (vehicle_speed / 100)  # Determinar dt segÃºn velocidad y distancia
    ...
    # Heading (direcciÃ³n de movimiento)
    ...
    # ============================================================
    # Datos de Estabilidad con correlaciÃ³n a trayectoria
    # ============================================================
...
def save_data(gps_df, stability_df, gps_path, stability_path):
    """Guardar datos en formato compatible con visualizaciÃ³n."""
...
if __name__ == '__main__':
    ...
    print("Puedes usarlos asÃ­:")
    print(f'  python src/lidar_stability/visualization/visualize_all.py "LiDAR-Maps\\cnig\\" "output\\synthetic\\GPS_synthetic.txt" "output\\synthetic\\STABILITY_synthetic.txt" --sample 0.01')
