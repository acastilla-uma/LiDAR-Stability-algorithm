...
Usage:
    python src/lidar_stability/pipeline/audit_pipeline_coverage.py
    python src/lidar_stability/pipeline/audit_pipeline_coverage.py --output output/results/pipeline_audit.csv
"""
